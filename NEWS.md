...
* Implements Lee & Wooldridge (2025) DiD estimator via unit-specific pre-treatment transformations
...
* Vignette replicating all numerical results from Lee & Wooldridge (2025) Table 7.2
